...
<VirtualHost *:80>
    ServerAdmin azeemopebiyi@gmail.com
...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=azeem/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=azeem/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=azeem24/' /var/www/html/laravel/.env
